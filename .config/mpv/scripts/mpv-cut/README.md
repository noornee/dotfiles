...
The core functionality of this extension is to very quickly cut videos both
losslessly and re-encoded-ly with the help of the fantastic media player
[mpv](https://mpv.io/installation/). You can also easily specify custom actions
in a `config.lua` file to support your own use cases.

There is also the added functionality of *cut lists* and *bookmarks*. More
details in [usage](#usage).
...
You can press `a` to cycle between the three default actions:
